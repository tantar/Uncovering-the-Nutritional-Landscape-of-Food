...
if type == "Individual Foods":
    ...
    vit = d.loc[(d.food == food) & (d.DRI_name.str.contains("vita|fol|nia|flav|thia",case=False))].sort_values("DRI_name")
    min = d.loc[(d.food == food) & (d.DRI_name.str.contains(","))].sort_values("DRI_name")
    ...
    fig.add_trace(go.Bar(x=vit.DRI_name, y=vit.Percent_of_daily_intake * 100, marker={'color': colors[2]}),2,1)
